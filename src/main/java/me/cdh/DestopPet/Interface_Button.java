...
public class Interface_Button extends Picture {
    ...
    public static void Reset_resetBasicSize(){
        UserData.SetUp.RobotSize robotSize1 = UserData.SetUp.OrderToEnum(MainAWT.userData.setUp.TempOrder);
...
;
    ...
    public static void Display_Button(Button button, Graphics2D g, NewFrame frame){
    ...
    //绘制按钮
    public static void Display_Interface(Interface_Button face,Graphics2D g, NewFrame frame){
...
;
    ...
    //皮肤
    public static Button[] Global_SetUp_Button;public static int SetUp_Button_Num = 13;
    //按钮
    ...
    ;
    //食物图片对象
    public static int Food_Button_Num = Food_Picture_Num+1;public static int Food_CurrentOrder;
    //食物按钮
    public static int Clothes_Num = 5;public static int Clothes_CurrentOrder;
...
;
    ...
    public static void Global_Interface_Button_LocationData_Init(){
        double BasicZoom = MainAWT.FishRoe.BasicSize/MainAWT.FishRoe.BasicBody.Image_B.getHeight();
        ...
        Global_SetUpSwitch.Dst = MainAWT.FishRoe.Get_PictureRelativeLocation_OfBasicBody(Global_SetUpSwitch.Src,
                Global_SetUpSwitch.SrcCentre,
                new Point(MainAWT.FishRoe.BasicBody.Dst.width/2, (int)(Button.Switch_Relative_Y*BasicZoom)),
        ...
        Global_SetUpButton.Dst = MainAWT.FishRoe.Get_PictureRelativeLocation_OfBasicBody(Global_SetUpButton.Src,
                Global_SetUpButton.SrcCentre,
                new Point(MainAWT.FishRoe.BasicBody.Dst.width + SetUpButton_X,
        ...
        Global_BatteryButton.Dst = MainAWT.FishRoe.Get_PictureRelativeLocation_OfBasicBody(Global_BatteryButton.Src,
                Global_BatteryButton.SrcCentre,
                new Point(MainAWT.FishRoe.BasicBody.Dst.width + BatteryButton_X,
                        (int)(MainAWT.FishRoe.BasicBody.Dst.height/2.0)),
        ...
        Global_LoveButton.Dst = MainAWT.FishRoe.Get_PictureRelativeLocation_OfBasicBody(Global_LoveButton.Src,
                Global_LoveButton.SrcCentre,
                new Point(MainAWT.FishRoe.BasicBody.Dst.width + LoveButton_X,
                        (int)(MainAWT.FishRoe.BasicBody.Dst.height/2.0)),
        ...
        Global_ExitButton.Dst = MainAWT.FishRoe.Get_PictureRelativeLocation_OfBasicBody(Global_ExitButton.Src,
                Global_ExitButton.SrcCentre,
                new Point(MainAWT.FishRoe.BasicBody.Dst.width + ExitButton_X,
                        (int)(MainAWT.FishRoe.BasicBody.Dst.height/2.0)),
        ...
        Global_ClothesButton.Dst = MainAWT.FishRoe.Get_PictureRelativeLocation_OfBasicBody(Global_ClothesButton.Src,
                Global_ClothesButton.SrcCentre,
                new Point(MainAWT.FishRoe.BasicBody.Dst.width + ClothesButton_X,
                        (int)(MainAWT.FishRoe.BasicBody.Dst.height/2.0)),
...
;
        ...
        Global_SetUp_Interface.Reset_Dst(new Point((int) (NewFrame.GetScreenWH()[0]/2.0),
                        (int)(NewFrame.GetScreenWH()[1]/2.0)),
                new Point(0,0));
        //Dst
        ...
        Global_MoodSystem_Interface.Reset_Dst_WithWH(new Point((int) (NewFrame.GetScreenWH()[0]/2.0),
                        (int)(NewFrame.GetScreenWH()[1]/2.0)),
        ...
        Global_FoodSystem_Interface.Reset_Dst_WithWH(new Point((int) (NewFrame.GetScreenWH()[0]/2.0),
                        (int)(NewFrame.GetScreenWH()[1]/2.0)),
        ...
        int Exit_w = 280;int Exit_y = 150;
        Global_Exit_Interface.Reset_Dst_WithWH(new Point((int) (NewFrame.GetScreenWH()[0]/2.0),
                        (int)(NewFrame.GetScreenWH()[1]/2.0)),
        ...
        Global_Clothes_Interface.Reset_Dst_WithWH(new Point((int) (NewFrame.GetScreenWH()[0]/2.0),
                        (int)(NewFrame.GetScreenWH()[1]/2.0)),
...
;
        ...
        for(int i = 0;i < Food_Picture_Num;i++){
            ...
            double basicZoom = 0.8;double finalZoom = MainAWT.FishRoe.Basic_Zoom*basicZoom;
    ...
    public static void Global_Interface_Button_Text_Init(){
        ...
        for(int i = 0;i < 2;i++){
            ...
            int start_x = 80;int buttonGap_x = 120;int start_y = 100;
    ...
    public static void Global_Interface_Button_Event_Init(){
        ...
        if(Interface_Button.Global_Clothes_Interface.List_Button != null && Interface_Button.Global_Clothes_Interface.List_Button.size() > 0){
            ...
            //添加锁定Button+Text
        if(Interface_Button.Global_SetUp_Interface.List_Texts != null && Interface_Button.Global_SetUp_Interface.List_Texts.size() > 0){
        ...
        if(Interface_Button.Global_MoodSystem_Interface.List_Texts != null && Interface_Button.Global_MoodSystem_Interface.List_Texts.size() > 0){
        ...
        if(Interface_Button.Global_FoodSystem_Interface.List_Texts != null && Interface_Button.Global_FoodSystem_Interface.List_Texts.size() > 0){
        ...
        if(Interface_Button.Global_Exit_Interface.List_Texts != null && Interface_Button.Global_Exit_Interface.List_Texts.size() > 0){
            for(Display.Text text : Interface_Button.Global_Exit_Interface.List_Texts){
                mouseDragged_Exit_Interface.Lock_AddLockText(text);
            }
        }
        if(Interface_Button.Global_Clothes_Interface.List_Texts != null && Interface_Button.Global_Clothes_Interface.List_Texts.size() > 0){
